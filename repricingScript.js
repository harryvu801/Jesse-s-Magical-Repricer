...
const businessPricingPath = path.resolve('Business Pricing 2.3.20 - Sheet272.txt')
const businessPricingFile = fs.createReadStream(businessPricingPath)
        ...
        papa.parse(rockBottomPricesFile, {
            ...
            complete: (y) => {
               ...
               console.log('ROCK BOTTOM PRICES LOADED')
                ...
                // papa.parse(businessPricingFile, {
                //    header: true,
                //    skipEmptyLines: true,
                //    complete: (z) => {
                //        let businessPricing = z.data
                //        console.log('BUSINESS PRICING LOADED', businessPricing.length)
